function Bootstrapper(_pageTitle, _theme) {
    document.write(`
        ...
        <hr>
            ...
            <div><img src="../images/record.png" style="padding: 5px; width: calc(100% - 10px); height: calc(100% - 10px);" onclick="ToPage('music.html')"></div>
            <div><img src="../images/covers/the_philosophical_podcast_cover.png" style="padding: 5px; width: calc(100% - 10px); height: calc(100% - 10px);" onclick="ToPage('thephilosophicalpodcast.html')"></div>
            <hr>
